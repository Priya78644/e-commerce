...
@section('content')
    <div class="w-full lg:max-w-none mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-500 ml-1 md:ml-2 font-medium">Silver Jewellery</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="container mx-auto py-8">
            <h2 class="text-2xl font-semibold mb-4 text-gray-800">Silver Jewellery <span class="text-yellow-600">2471
                    Designs</span></h2>
